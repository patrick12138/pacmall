<template>
  <div class="mod-home">
    <h1 align="center" style="display: flex;justify-content: center;flex-direction: column;min-height: 80vh">派克商城</h1>
<!--    <h3>项目介绍</h3>-->
<!--    <ul>-->
<!--      <li>pacmall-admin基于vue、element-ui构建开发，实现<a href="https://gitee.com/renrenio/renren-fast" target="_blank">renren-fast</a>后台管理前端功能，提供一套更优的前端解决方案</li>-->
