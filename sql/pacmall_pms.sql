/*
 ...
 Source Schema         : pacmall_pms

 Target Server Type    : MySQL
 Target Server Version : 50737
 File Encoding         : 65001

 Date: 07/07/2022 18:42:18
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 1355232957562881 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1355161784606720, '上市年份', 0, 'XX', '2018', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355162021617664, '入网型号', 0, 'XX', 'A12;A23', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355162619289600, '机身颜色', 0, 'XX', '黑色;白色;蓝色', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (1355165625688064, 'CPU品牌', 0, 'XX', '骁龙;天机;麒麟', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355167727525888, 'CPU型号', 0, 'XX', '骁龙888;骁龙8gen1;天机8100;天机9000;麒麟9000', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355170522275840, '销售额', 0, 'XX', '1000', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355170828935168, '屏幕素质', 0, 'XX', '1080P;1440P', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355232909008896, '颜色', 0, 'XX', '星河银', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (1355232957562880, '版本', 0, 'xx', '8GB+128GB;8GB+256GB', 0, 1, 225, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1355170828943361 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1355161784606721, 1355161784606720, 1355161748316160, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1355162021617665, 1355162021617664, 1355161748316160, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1355162619289601, 1355162619289600, 1355161708756992, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1355165625696256, 1355165625688064, 1355161708756992, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1355167727534080, 1355167727525888, 1355161708756992, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1355170828943360, 1355170828935168, 1355161724592128, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1355161748316161 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1355161708756992, '基本信息', 1, '基本信息', 'XX', 225);
INSERT INTO `pms_attr_group` VALUES (1355161724592128, '屏幕', 1, '屏幕', 'XX', 225);
INSERT INTO `pms_attr_group` VALUES (1355161748316160, '主体', 1, '主体信息', 'xx', 225);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1355161457065985 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1355161359212544, '华为', 'https://pacmall.oss-cn-guangzhou.aliyuncs.com/2022-06-03/081909e6-6a13-46aa-8793-37dbd02b81ed_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (1355161371418624, '小米', 'https://pacmall.oss-cn-guangzhou.aliyuncs.com/2022-06-03/83affdee-7d91-4134-8848-5970493e2329_xiaomi.png', '小米', 1, 'X', 1);
INSERT INTO `pms_brand` VALUES (1355161417900032, 'OPPO', 'https://pacmall.oss-cn-guangzhou.aliyuncs.com/2022-06-03/2f7f95aa-bf30-4b55-8d17-4c53dce5c8ac_oppo.png', 'OPPO', 1, 'O', 1);
INSERT INTO `pms_brand` VALUES (1355161457065984, '苹果', 'https://pacmall.oss-cn-guangzhou.aliyuncs.com/2022-06-03/38784ecf-b1f6-48b0-8422-719edeb7d994_apple.png', '苹果', 1, 'P', 1);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1355161481396225 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (1355161467756544, 1355161359212544, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (1355161475186688, 1355161371418624, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (1355161479266304, 1355161417900032, 225, 'OPPO', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (1355161481396224, 1355161457065984, 225, '苹果', '手机');
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1355234524733441 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (1355234524733440, '华为 Mate 40', '华为 Mate 40', 225, 1355161359212544, 0.1980, 0, NULL, NULL);
