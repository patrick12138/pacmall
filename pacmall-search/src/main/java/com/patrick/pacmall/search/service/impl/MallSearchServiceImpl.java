package com.patrick.pacmall.search.service.impl;
...
import com.patrick.pacmall.search.constant.EsConstant;
import com.patrick.pacmall.search.feign.ProductFeignService;
import com.patrick.pacmall.search.service.MallSearchService;
import com.patrick.pacmall.search.vo.AttrResponseVo;
import com.patrick.pacmall.search.vo.BrandVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParamVo paramVo) {
        ...
        try {
            //执行检索请求
            SearchResponse response = client.search(searchRequest, PacmallElasticConfig.COMMON_OPTIONS);
            //分析封装响应数据
